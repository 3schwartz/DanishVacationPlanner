      ...
      <View style={styles.calendar}>
        <View style={styles.heading}>
          <TouchableOpacity onPress={previousMonth}>
            <Text style={{ fontFamily: "Tajawal-Regular" }}>{'< Forrige'}</Text>
          </TouchableOpacity>
          <Text style={{ textTransform: "capitalize", fontFamily: "Tajawal-Regular" }}>
            {this.state.focusedMonth.format('MMMM')}
          </Text>
          <TouchableOpacity onPress={nextMonth}>
            <Text style={{ fontFamily: "Tajawal-Regular" }}>{'Næste >'}</Text>
          </TouchableOpacity>
        </View>
        <Month
